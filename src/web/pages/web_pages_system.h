/*
 * Web Page - System Info
 * HTML/CSS/JavaScript for system diagnostics page
 * Displays firmware, memory, storage, WiFi, and battery info
 */

#ifndef WEB_PAGES_SYSTEM_H
#define WEB_PAGES_SYSTEM_H
