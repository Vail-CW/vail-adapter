...
VailAdapter::VailAdapter(unsigned int PiezoPin) {
    ...
    this->ditKey = DEFAULT_DIT_KEY;
    this->dahKey = DEFAULT_DAH_KEY;
}
...
uint8_t VailAdapter::getDahKey() const {
    return this->dahKey;
}
...
void VailAdapter::HandleMIDI(midiEventPacket_t event) {
    ...
    switch (event.byte1) {
        ...
        case 0xC0:
            ...
            saveSettingsToEEPROM(event.byte2, this->ditDuration, this->txNote, this->ditKey, this->dahKey);
            break;
        case 0x80:
