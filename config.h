...
// Arduino Micro custom build
// Capacitive touch disabled for AVR/32U4 boards like the Micro
#define NO_CAPACITIVE_TOUCH

// Optional: disable built-in LED handling
#define NO_LED
...
// If you later add a resistor-ladder menu button input, uncomment this:
...
// Optional radio outputs:
// #define RADIO_DIT_PIN A3
// #define RADIO_DAH_PIN A2
// #define HAS_RADIO_OUTPUT

// --- RADIO KEYING POLARITY ---
// Set to true if your radio key/PTT line activates when pulled LOW.
// Set to false if it activates when driven HIGH.
#define RADIO_KEYING_ACTIVE_LOW false
...
// Morse code timing at 20 WPM (startup sound only)
...
#define DIT_HOLD_BUZZER_DISABLE_THRESHOLD 5000
#define DAH_SPAM_COUNT_RADIO_MODE 10
#define DAH_SPAM_WINDOW 500
#define DAH_HOLD_RADIO_KEYER_TOGGLE_THRESHOLD 5000
